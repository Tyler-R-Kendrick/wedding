...
/**
 * Our Venue in five acts on the axis: the building (numbered, cited statements), the spaces as a
 * floor plan, the docent list, the outlets ledger, and getting here.
 */
export const GildedOurVenuePage: ContentRecipe<OurVenueProps> = ({ data, frame }) => {
