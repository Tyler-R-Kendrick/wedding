...
/** Ask Us: search on the axis, the FAQ as a ruled column, the concierge on the plaque below it.
 * Not numbered — these are three utilities, not one of the five acts. */
export const BotanicalAskPage: ContentRecipe<AskProps> = ({ faq, search, concierge, frame }) => (
  <Shell frame={frame} banner={<PreviewBanner lifecycle={frame.lifecycle} />}>
    ...
    <Section id="search" labelledBy="search-title">
      ...
      <form className="bd-form bd-form--search" method="get" action={ROUTES.ask} role="search">
    ...
    <Section id="concierge" labelledBy="concierge-title">
      ...
      <div className="bd-slot" id="concierge-slot" data-slot="concierge">
        {concierge ?? (
          <Prose>
