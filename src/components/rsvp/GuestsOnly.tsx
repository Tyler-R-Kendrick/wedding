...
export function GuestsOnly({ what }: { what: string }) {
  return (
    <main id="main" className="page">
      <p className="page__eyebrow">Invited guests</p>
      ...
      <p className="card__meta">Lost the link? TODO(Tyler &amp; Sara): how to reach the couple.</p>
    </main>
  );
}
...
export function FriendlyFailure({ what }: { what: string }) {
  return (
    <main id="main" className="page">
      ...
      <p>If it keeps happening, reach Sara and Tyler directly. TODO(Tyler &amp; Sara): contact details.</p>
    </main>
  );
}
