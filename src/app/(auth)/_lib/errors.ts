...
export const ERROR_COPY: Record<string, string> = {
  ...
  locked: 'Too many incorrect codes. For your security, sign-in is paused for about 15 minutes — a new code will be sent but refused until the pause lifts, so please wait before asking for one.',
