# Design critique — `/our-adventures` (Our Adventures) — Conservatory — 2026-09-05
...
- **BL-2** — the floating Menu tag is now reserved for (89.25 px against 60 px of chrome).
- **SF-1** — visible attribution restored at 18.06 px.
- Still open (**SF-12**): one public record; backlog C-02.
...
- `IMPECCABLE_BROWSER=… npx impeccable detect "http://localhost:3105/our-adventures?theme=conservatory"`: **exit 0** (all 20 URLs including Home)
