...
| [ ] | C-06 | registry provider and choices; which ways to receive gifts of money (Venmo / PayPal.Me / $Cashtag / Zelle / mailing address) and whether the four default funds (honeymoon, home, adoption, next adventures) read right | RSVP_OPEN | Gifts (provider adapter ADR-0004; funds and ways to give ADR-0013) | Language: "help us with our next adventures", never "cash fund"/"donate"; no amounts |
