...
export const CREDENTIALS = [
  {
    id: 'anthropic', title: 'Anthropic API key', vars: ['ANTHROPIC_API_KEY'],
  ...
  {
    id: 'openai', title: 'OpenAI API key', vars: ['OPENAI_API_KEY'],
  ...
  {
    id: 'voyage', title: 'Voyage AI key', vars: ['VOYAGE_API_KEY'],
  ...
  {
    id: 'resend', title: 'Resend API key', vars: ['RESEND_API_KEY'],
  ...
  {
    id: 'database', title: 'Postgres database', vars: ['DATABASE_URL'],
  ...
  {
    id: 'openverse', title: 'Openverse client', vars: ['OPENVERSE_CLIENT_ID', 'OPENVERSE_CLIENT_SECRET'],
  ...
  {
    id: 'fal', title: 'fal.ai key', vars: ['FAL_KEY'],
  ...
  {
    id: 'stitch', title: 'Google Stitch key', vars: ['STITCH_API_KEY'],
  ...
  {
    id: 'storage', title: 'S3-compatible bucket', vars: ['S3_ENDPOINT', 'S3_BUCKET', 'S3_ACCESS_KEY_ID', 'S3_SECRET_ACCESS_KEY'],
  ...
  {
    id: 'cloudflare-stream', title: 'Cloudflare Stream', vars: ['CLOUDFLARE_ACCOUNT_ID', 'CLOUDFLARE_STREAM_API_TOKEN', 'CLOUDFLARE_STREAM_CUSTOMER_CODE'],
  ...
  {
    id: 'duffel', title: 'Duffel access token', vars: ['DUFFEL_API_KEY'],
  ...
  {
    id: 'skyscanner', title: 'Skyscanner partner key', vars: ['SKYSCANNER_API_KEY'],
  ...
  {
    id: 'booking', title: 'Booking.com Demand API', vars: ['BOOKING_DEMAND_API_KEY', 'BOOKING_AFFILIATE_ID'],
  ...
  {
    id: 'uber', title: 'Uber for Business', vars: ['UBER_CLIENT_ID', 'UBER_CLIENT_SECRET', 'UBER_ORG_ID', 'UBER_VOUCHER_PROGRAM_ID'],
...
/**
 * Outcomes, not variables. The page asks Tyler & Sara which of these they want;
 * the agent resolves them into credentials and runs the ladder.
 */
export const CAPABILITIES = [
  { id: 'run', title: 'Just run the site locally', outcome: 'Every page works, on embedded Postgres, with providers mocked.', needs: [], always: true },
  { id: 'email', title: 'Send real e-mails to guests', outcome: 'One-time codes and RSVP confirmations arrive in real inboxes.', needs: ['resend'] },
  { id: 'concierge', title: 'Turn on the AI concierge', outcome: 'Guests can ask about the weekend and get real answers.', needs: ['anthropic'] },
  { id: 'search', title: 'Search photos and stories well', outcome: 'Real embeddings instead of the hashed mock.', needs: ['voyage', 'openai'], anyOf: true },
  { id: 'photos', title: 'Keep guest photos safely', outcome: 'Uploads go to object storage instead of the sandbox disk.', needs: ['storage'] },
  { id: 'video', title: 'Play guest videos smoothly', outcome: 'Cloudflare Stream transcodes and serves clips.', needs: ['cloudflare-stream'] },
  { id: 'persist', title: 'Keep data between sandboxes', outcome: 'A hosted Postgres the next session reconnects to.', needs: ['database'] },
  { id: 'travel', title: 'Show live travel prices', outcome: 'Real flight and hotel numbers on the Travel page.', needs: ['duffel', 'skyscanner', 'booking'], anyOf: true },
  { id: 'rides', title: 'Give guests ride vouchers', outcome: 'Uber for Business vouchers for the night of.', needs: ['uber'] },
  { id: 'design', title: 'Generate design imagery', outcome: 'fal.ai mood boards, textures and comps.', needs: ['fal', 'stitch'], anyOf: true },
  { id: 'assets', title: 'Fetch placeholder imagery faster', outcome: 'Openverse at a higher rate limit.', needs: ['openverse'] },
];
