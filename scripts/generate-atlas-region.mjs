...
/**
 * The close-up covers Lake Michigan whole, from Madison to Door County to the Indiana dunes, with
 * room around every Midwest pin. Equal Earth leans the meridians, so the rectangle drawn is narrower
 * than this box at the south: at Starved Rock's latitude its west edge is about 91°W. (At -93° it
 * was 89.02°W, three hundredths of a degree from the pin, and everything west of it was blank.)
 */
const BOX = { west: -95, east: -82, south: 39, north: 47.5 };
...
export const REGION_VERSION = '${createHash('sha256').update(svg).digest('hex').slice(0, 12)}';
