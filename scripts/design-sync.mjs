...
function generateTheme(themeId) {
  ...
  const lines = [
    `/* stylelint-disable -- GENERATED by scripts/design-sync.mjs from src/themes/${themeId}/DESIGN.md (+ design.json). DO NOT EDIT. */`,
...
function generateTailwindTheme(themeId) {
  ...
  return [
    `/* stylelint-disable -- GENERATED by scripts/design-sync.mjs from src/themes/${themeId}/DESIGN.md (design.md export --format css-tailwind). DO NOT EDIT. */`,
