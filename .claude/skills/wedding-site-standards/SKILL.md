...
| **Our Venue** (`/our-venue`) | Venue | Building overview, spaces, history with provenance and `lastVerifiedAt`, on-property outlets as live links, parking/valet/accessibility fields, "look for this" details | Floor plan with the guest's table when published |
